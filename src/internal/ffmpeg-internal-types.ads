with ffmpeg.internal.csizes;
use ffmpeg.internal.csizes;
package ffmpeg.internal.types is 
  ...
  type AVCodec_Context_T is limited null record with Convention => C, Size => AVCodec_Size;
  ...
  type AVPacket_T is limited null record with Convention => C, Size => AVPacket_Size;
  type AVPacket_Access_T is access all AVPacket_T with Convention => C;

  type AV_Picture is limited null record with Size => AVPicture_Size, Convention => C;
  ...
  type AVSubtitleRect_T is limited record 
    ...
    Flags : C.Int;
  end record with Convention => C, Size => AVSubtitleRect_Size;
  ...
  end record with Convention => C, Size => AVSubtitle_Size;
  ...
  type AVFrame_T is limited null record with Convention => C, Size => AVFrame_Size;
